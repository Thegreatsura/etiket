...
// ---------------------------------------------------------------------------
// RAP (Row Address Pattern) lookup tables from ISO/IEC 24728
// 52 entries each. Values are decimal representations of 10-bit patterns.
// Each bit is a module: 1=bar, 0=space
// ---------------------------------------------------------------------------

// prettier-ignore
const RAP_LEFT_RIGHT: number[] = [
...
// ---------------------------------------------------------------------------
// Symbol metrics: [columns, rows, ecCW, rapl, rapc, rapr]
// data CW = (rows * columns) - ecCW
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Render a RAP pattern as 10 boolean modules
// ---------------------------------------------------------------------------
