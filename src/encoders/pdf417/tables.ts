 ...
 *
 * Each entry is a 17-bit bitmask representing the module pattern for a codeword.
 * Bit 16 (MSB) is the leftmost module; bit 0 is the rightmost.
 * 1 = black bar, 0 = white space.
 *
 * To convert to bar/space widths, decode the bitmask into runs of 1s and 0s.
 * Each valid pattern has exactly 4 bars and 4 spaces (8 alternating runs).
 */

// prettier-ignore
const CLUSTER_0: number[] = [
...
export const TEXT_SWITCH = {
  // from Alpha
  ALPHA_TO_LOWER: 27, // LL - latch to lower
  ALPHA_TO_MIXED: 28, // ML - latch to mixed
  ALPHA_TO_PUNCT_SHIFT: 29, // PS - single-char shift to punct

  // from Lower
  LOWER_TO_ALPHA_SHIFT: 27, // AS - single-char shift to alpha
  LOWER_TO_MIXED: 28, // ML - latch to mixed
