...
/**
 * EC generator polynomial coefficient tables from ISO/IEC 15438:2001(E) Annex F.
 * These are the coefficients g_0, g_1, ..., g_{k-1} of the generator polynomial
 * g(x) = x^k + g_{k-1}*x^{k-1} + ... + g_1*x + g_0
 * where g(x) = (x - 3^1)(x - 3^2)...(x - 3^k) over GF(929).
 */
// prettier-ignore
const EC_COEFFICIENTS: readonly (readonly number[])[] = [
  /* L0, k=2   */ [27, 917],
  /* L1, k=4   */ [522, 568, 723, 809],
  /* L2, k=8   */ [237, 308, 436, 284, 646, 653, 428, 379],
  /* L3, k=16  */ [274, 562, 232, 755, 599, 524, 801, 132, 295, 116, 442, 428, 295, 42, 176, 65],
  /* L4, k=32  */ [
 ...
 *
 * Uses the algorithm described in ISO/IEC 15438:2001(E) section 4.10
 * with pre-computed coefficient tables from Annex F.
 *
